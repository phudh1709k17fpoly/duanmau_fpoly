...
<style>
 ...
 <section class="container">
   <form action="index.php?asp=editprd&id=<?=$_GET['id']?>" method="post" enctype="multipart/form-data">
     <div class="row mb-4">
       <div class="col">
       <input type="hidden" name="id" value="<?=$iteams['id']?>">
         <div class="form-outline">
           <label class="form-label" for="form6Example1">Name Products</label>
           <input type="text" name="name" id="form6Example2" class="form-control" value="<?= $iteams['name']?>">
   ...
   <small id="emailHelp" style="color:red;font-size:18px;"><?php if(!empty($Error_message['check_img'])){
     ...
     <div class="row mb-4">
       <div class="col">
         <div class="form-outline">
           ...
           <input type="number" name="price" id="form6Example2" class="form-control"  value="<?= $iteams['price']?>">
       ...
       <div class="col">
         <div class="form-outline">
           ...
           <input type="number" name="quantity" id="form6Example2" class="form-control" value="<?= $iteams['quantity']?>">
         ...
         <div class="form-outline">
           ...
           <select class="form-select" aria-label="Default select example" name="id_cate">
             ...
             <?php foreach ($cate as $catenews) : ?>
               <option value="<?= $catenews['id'] ?>" <?= $iteams['id_cate'] == $catenews['id'] ? 'selected' : '' ?>><?= $catenews['type'] ?></option>
             <?php endforeach ?>
           </select>
     ...
     <div class="col">
       <div class="form-outline">
         ...
         <br>
         <textarea name="detail" cols="100" rows="5"><?= $iteams['detail']?></textarea>
